...
class TextInput:
    ...
    def __init__(self, default_text="",
        ...
        # Things cursor:
        self.cursor_surface = pygame.Surface((int(self.font_size/5+1), 2*self.font_size))
        self.cursor_surface.fill(cursor_color)
        self.cursor_position = len(default_text)    # Inside text
    ...
    def update(self, events):
        ...
        self.cursor_surface = pygame.Surface((int(self.font_size / 10 + 1), self.surface.get_height()))
